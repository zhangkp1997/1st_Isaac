...
All the environments are registered in the `isaac_workthrough` extension. They start
...
import isaac_workthrough.tasks  # noqa: F401


def main():
    """Print all environments registered in `isaac_workthrough` extension."""
